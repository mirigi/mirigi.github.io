...
layout: feature
keywords: building automation, smart building, integration, sensors, controls, gateway
description: Connect the building's sensors and controls into Mirigi, so residents and staff act from one app.
miri_ai_example:
  - from: user
    text: "What's the pool temperature right now?"
  - from: miri
