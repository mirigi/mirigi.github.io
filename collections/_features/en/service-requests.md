...
miri_ai_example:
  - from: user
    text: "Hi Miri, the elevator in my tower is making a strange grinding noise when it reaches my floor. It started this morning."
  - from: miri
    text: "Thanks for reporting that. I will open a maintenance request for the elevator on your behalf — which tower and which floor are you on so I can include it in the ticket?"
  - from: user
    text: "Tower B, 14th floor. It happens every time the doors open here."
  - from: miri
    text: "Got it. I have created a maintenance request titled \"Elevator grinding noise — Tower B, 14th floor\" and routed it to the building's maintenance role. You will get a push notification when staff acknowledges it or replies."
---
