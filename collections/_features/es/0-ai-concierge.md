...
layout: feature
keywords: conserjería con ia, miri, chat, inteligencia artificial, experiencia del residente, automatización
...
Para el personal, Miri **absorbe discretamente el tráfico rutinario** que llena el día de una recepción. Cada acción que realiza fluye a través de los **mismos flujos de trabajo que ya usan el portero, el valet y la administración**, por lo que nada cambia en el back end. **Las llamadas entrantes bajan**, la coordinación manual se aligera y el equipo queda libre para concentrarse en la **hospitalidad presencial** que define a un edificio de lujo.
