...
image_credits: ''
layout: feature
keywords: encuestas, votación, sondeos, opinión de residentes, toma de decisiones, participación comunitaria
description: Realiza encuestas y recoge la opinión de los residentes fácilmente con Mirigi.
miri_ai_example:
  - from: miri
    text: "Hay una encuesta abierta para tu edificio: \"Reemplazar el piso del lobby — Opción A: parquet de roble, Opción B: porcelanato, Opción C: mantener el actual.\" La votación cierra el viernes. ¿Quieres emitir el voto de tu unidad?"
  - from: user
    text: "Sí, vamos con el porcelanato."
  - from: miri
    text: "Entendido — registrando un voto por la Opción B (porcelanato) en nombre de tu unidad. Es un único voto bloqueado por unidad, así que no podrá modificarse después. ¿Confirmas el envío?"
  - from: user
    text: "Confirmo."
  - from: miri
    text: "Listo. La respuesta de tu unidad ha quedado registrada. Como esta encuesta tiene resultados públicos, puedes consultar el recuento en vivo en cualquier momento desde la página de Encuestas."
---
