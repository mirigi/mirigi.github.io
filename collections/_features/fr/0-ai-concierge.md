---
title: "Miri — Le Premier Agent de Conciergerie IA Qui Agit"
...
description: "Miri est le premier agent de conciergerie IA qui agit — pas seulement des réponses. Elle passe les commandes, appelle le voiturier et réserve les installations de bout en bout."
---

Découvrez Miri, le premier agent de conciergerie IA conçu pour agir — pas seulement pour répondre. Les résidents s'expriment naturellement — "Je voudrais des Spaghetti Carbonara livrés dans mon appartement" ou "montez ma voiture dans 10 minutes" — et Miri gère tout de bout en bout. Pas de menus d'application à parcourir, pas de formulaires à remplir. Il suffit de demander.
