...
layout: feature
keywords: demandes de service, maintenance, communication, retour, efficacité, satisfaction des résidents
description: Soumettez et suivez les demandes de service efficacement avec Mirigi.
miri_ai_example:
  - from: user
    text: "Bonjour Miri, l'ascenseur de ma tour fait un étrange bruit de grincement lorsqu'il atteint mon étage. Cela a commencé ce matin."
  - from: miri
    text: "Merci de l'avoir signalé. Je vais ouvrir une demande de maintenance pour l'ascenseur en votre nom — dans quelle tour et à quel étage êtes-vous, afin que je puisse l'inclure dans la demande ?"
  - from: user
    text: "Tour B, 14e étage. Cela se produit chaque fois que les portes s'ouvrent ici."
  - from: miri
    text: "Compris. J'ai créé une demande de maintenance intitulée \"Bruit de grincement de l'ascenseur — Tour B, 14e étage\" et l'ai acheminée au rôle de maintenance de l'immeuble. Vous recevrez une notification push lorsque le personnel l'aura accusée réception ou y aura répondu."
---
